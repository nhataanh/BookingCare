...
const Profile = ({doctorData}) => {
  ...
  const addQualification = e =>{
    ...
    addItem('qualifications',{
      startingDate: "", endingDate: "", degree: "PHD", university: "Dhhaka Medical College"
    })
  }
              ...
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  ...
                  <div className="flex items-center">
                    <button onClick={e=>deleteTimeSlot(e,index)} className="bg-red-600 p-2 rounded-full text-white text-[18px] cursor-pointer mt-7">
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
