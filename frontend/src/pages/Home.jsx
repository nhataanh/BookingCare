            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className='text_para'>
                  ...
                  quia earum amet arrchitecto, modi odio, soluta unde ducimus perferendis?
                </p>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                  ...
                  umatched, expert health care. From the lab to the clinic.
                </p>

                <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solib border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor'>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className='text_para text-center'>
              world-class care for everyone. Our health System offers umatchecd,
              expert health care.
            </p>
          </div>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text_para">
                  2. Search for your physician here, and contact theri office.
                </li>
                <li className="text_para">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:x-4 lg:pb-[26px] rounded-[10px]">
